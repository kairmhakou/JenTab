...
def remove_special_chars(word):
    ...
    # remove parenthesis NY: special character added to the odd '"', commonly found in the Round 2 BioTables,
    # Generic_lookup fails to handle, however, we remove it here to be handled by the Full Cell Strategy
    # odd_chars = ['[', ']', '{', '}', '(', ')', '*', '^', '/', '\\', '"']
    odd_chars = ['[', ']', '{', '}', '*', '^', '/', '\\', '"']
